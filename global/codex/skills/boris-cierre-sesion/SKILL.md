---
name: boris-cierre-sesion
description: Cierre completo de sesion Boris. Usalo para diagnosticar la sesion, verificar estado, detectar deuda tecnica y dejar un next step claro.
---
...
6. Commit/push: si hay cambios, muestra resumen y pregunta si ejecutar `boris-quick-commit` o `boris-commit-push-pr`. Nunca commitees sin confirmacion explicita.
